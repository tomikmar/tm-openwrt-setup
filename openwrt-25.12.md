...
## Network
  ...
  * Interfaces
    ...
    #
    uci set network.lan.ipaddr='192.168.101.1/24'
    #
    uci commit network
    uci show network.lan.ipaddr
    ```
...
#### Remarks regarding additional networks (do not use)
...
## Install
    ...
    apk update
    # Network monitoring
    apk add ifstat iftop nload bmon hostapd-utils
    # Tools
    apk add diffutils usbutils
